...
•	There is an opportunity for T4Tech to improve their sales performance by offering exclusive discounts, incentives and rewards on MacBook Air Laptops when purchased through the loyalty program. This could be effective because the MacBook Air is a top seller, **yet 90% of its revenue and volume come from non-loyalty members who, on average, spend 10% less than loyalty program members.**  
